...
typedef void (*HandHeldBufferCallback)(unsigned char* data,int size);
typedef void (*FrameBufferCallback)(unsigned char* data,int size);
...
public:
    ...
    //手持设备数据格式回调
    void SetHDataCallback(HandHeldBufferCallback func);
